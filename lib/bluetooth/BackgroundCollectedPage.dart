...
import 'package:untitled/widgets/LineChart.dart';

import './BackgroundCollectingTask.dart';
import 'package:untitled/widgets/PaintStyle.dart';
        ...
        body: ListView(
          children: <Widget>[
            ...
            LineChart(
              ...
              values: [
                lastSamples.map((sample) => sample.humidity1),
                lastSamples.map((sample) => sample.humidity2),
              ],
            ...
            LineChart(
              ...
              argumentsLabels: argumentsLabels,
              values: [
                lastSamples.map((sample) => sample.battery),
              ],
              verticalLinesStyle: const PaintStyle(color: Colors.grey),
              additionalMinimalHorizontalLabelsInterval: 0,
              additionalMinimalVerticalLablesInterval: 0,
